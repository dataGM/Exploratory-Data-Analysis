...
with(powerConsum, plot(Date_Heure, Global_active_power, type = "l", xlab = "",
                       ylab = "Global Active Power"))

with(powerConsum, plot(Date_Heure, Voltage, type = "l", xlab = "datetime", 
                       ylab = "Voltage"))

with(powerConsum, plot(Date_Heure, Sub_metering_1, type = "l", xlab = "",
...
with(powerConsum, plot(Date_Heure, Global_reactive_power, xlab = "datetime", 
